...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Name for the address (e.g., Home, Office)', max_length=100)),
                ...
                ('phone', models.CharField(help_text='Phone number for this address', max_length=20)),
